...
// used to update vpromms search list if user adds / deletes a vpromm
export const ADD_VPROMMS_FIELD_ID = 'ADD_VPROMMS_FIELD_ID';
export const DELETE_VPROMMS_FIELD_ID = 'DELETE_VPROMMS_FIELD_ID';
