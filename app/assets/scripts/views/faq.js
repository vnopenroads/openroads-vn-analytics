      ...
      */}
      {
        language === 'en' ?
          <section className="question">
            ...
            <p>v3.4.0. A full changelog of the project is regularly published <a href='https://github.com/vnopenroads/openroads-vn-analytics/blob/master/CHANGELOG.md'>here.</a></p>
          </section> :
          <section className="question">
            <h3 className='inpage__title'>What's the current version of the platform?</h3>
            <p>v3.4.0.  A full changelog of the project is regularly published <a href='https://github.com/vnopenroads/openroads-vn-analytics/blob/master/CHANGELOG.md'>here.</a></p>
...
const Faq = ({ language }) => {
  ...
  return <SitePage pageName="Frequently Asked Questions"
