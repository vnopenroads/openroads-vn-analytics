    ...
    */}
    {
      language === 'en' ?
        <section className="question">
          ...
          <p>v3.4.0. A full changelog of the project is regularly published <a href='https://github.com/orma/openroads-vn-analytics/blob/develop/CHANGELOG.md'>here.</a></p>
        </section> :
        <section className="question">
          <h3 className='inpage__title'>What's the current version of the platform?</h3>
          <p>v3.4.0.  A full changelog of the project is regularly published <a href='https://github.com/orma/openroads-vn-analytics/blob/develop/CHANGELOG.md'>here.</a></p>
    ...
    <section>
      <p>
        ...
        <a href={`mailto:phan2@worldbank.org?cc=ptran1@worldbank.org&cc=cknguyen@worldbank.org&cc=tranthikimdang@gmail.com&cc=tailm.fu@gmail.com&subject=${translate(language, 'Question regarding ORMA, not answered in the FAQ')}`}>
...
const Faq = ({ language }) => (<SitePage pageName="Frequently Asked Questions" innerPage={this.innerPage(language)} />);
