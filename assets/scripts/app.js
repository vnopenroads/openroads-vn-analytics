...
},{"./routes.js":25,"backbone":2,"jquery":4}],2:[function(require,module,exports){
//     Backbone.js 1.1.2
...
},{"turf-distance":8,"turf-point":11}],8:[function(require,module,exports){
...
module.exports = {
  apiUrl: 'https://fast-dawn-4805.herokuapp.com'
...
},{"turf-inside":6,"turf-linestring":10,"turf-point":11}],16:[function(require,module,exports){
'use strict';
...
},{"spin":5}],18:[function(require,module,exports){
'use strict';
...
},{"./clip.js":15,"./helpers.js":16,"turf-line-distance":7,"underscore":12}],19:[function(require,module,exports){
'use strict';
...
},{"../config.js":13,"../lib/admin-type.js":14,"backbone":2}],21:[function(require,module,exports){
'use strict';
...
},{"../config.js":13,"../lib/stats.js":18,"backbone":2,"underscore":12}],22:[function(require,module,exports){
'use strict';
/* global rfolder */
var Backbone = require('backbone');
...
},{"../config.js":13,"backbone":2,"underscore":12}],24:[function(require,module,exports){
'use strict';
var Backbone = require('backbone');
var _ = require('underscore');
var config = require('../config.js');
...
},{"../config.js":13,"backbone":2,"underscore":12}],25:[function(require,module,exports){
'use strict';
...
},{"./lib/admin-type.js":14,"./lib/spinner.js":17,"./models/admin-list.js":20,"./models/admin-region.js":21,"./models/cached-admin-region.js":22,"./models/project.js":23,"./models/projects.js":24,"./templates/meta.html":31,"./views/admin-list.js":36,"./views/app.js":38,"./views/barangay.js":39,"./views/base-view.js":40,"./views/municipality.js":42,"./views/project.js":43,"./views/projects.js":44,"backbone":2,"jquery":4}],26:[function(require,module,exports){
...
with (locals || {}) { (function(){ 
 buf.push('');1; var _ = require('underscore'); ; buf.push('\n');2; var types = require('../lib/admin-type.js'); ; buf.push('\n\n');4; if(results.length) { ; buf.push('\n<ul>\n  ');6; _.forEach(results, function(result) { ; buf.push('\n    <li><a href="#/', escape((7,  result.id )), '" class="admin-area">', (7,  result.name.replace(term, '<strong>' + term + '</strong>') ), ' <small>', escape((7,  types.getByIndex(result.type).display )), '</small></a></li>\n  ');8; }); ; buf.push('\n</ul>\n\n');11; } else if (term === null) { ; buf.push('\n');12; } else { ; buf.push('\n  <p>No results available for <strong>', escape((13,  term )), '</strong></p>\n');14; } ; buf.push(''); })();
} 
return buf.join('');
}; return function(l) { return t(l) }}())
},{"../lib/admin-type.js":14,"underscore":12}],27:[function(require,module,exports){
module.exports=(function() {var t = function anonymous(locals, filters, escape, rethrow
/**/) {
escape = escape || function (html){
  return String(html)
...
var buf = [];
with (locals || {}) { (function(){ 
 buf.push('<label for="admin-search-text">Search administrative areas</label>\n<input type="text" name="admin-search-text" id="admin-search-text" placeholder="administrative area">\n\n<div class="results">\n  \n</div>'); })();
} 
return buf.join('');
}; return function(l) { return t(l) }}())
...
var buf = [];
with (locals || {}) { (function(){ 
 buf.push('');1; var _ = require('underscore'); ; buf.push('\n');2; var statsForDisplay = require('../lib/stats.js').statsForDisplay; ; buf.push('\n\n<article>\n', (5,  require('./sidebar.html')({ active: 'road-network', crumbs: crumbs, id: id }) ), '\n  <div id="content">\n\n    <h2>Road Condition</h2>\n\n    <table>\n    ');11; _.forEach(statsForDisplay(stats), function(stat) { ; buf.push('\n      <tr>\n        <td>', escape((13,  stat.display )), '</td>\n        <td>', escape((14,  stat.kilometers )), ' km</td>\n      </tr>\n    ');16; }); ; buf.push('\n    </table>\n\n  </div>\n</article>\n'); })();
} 
return buf.join('');
}; return function(l) { return t(l) }}())
},{"../lib/stats.js":18,"./sidebar.html":35,"underscore":12}],30:[function(require,module,exports){
module.exports=(function() {var t = function anonymous(locals, filters, escape, rethrow
/**/) {
escape = escape || function (html){
  return String(html)
...
var buf = [];
with (locals || {}) { (function(){ 
 buf.push('');1; var _ = require('underscore') ; buf.push('\n\n');3; var length = crumbs.length; ; buf.push('\n');4; if (!length) { ; buf.push('\n  <a href="#/" class="admin-area current">Philippines</a>\n');6; } else { ; buf.push('\n  <a href="#/" class="admin-area">Philippines</a>&nbsp;/&nbsp;\n\n  ');9; _.each(crumbs, function(crumb, i) { ; buf.push('\n    ');10; if (i === length-1) { ; buf.push('\n      <a href="#/', escape((11,  crumb.id )), '" class="admin-area current">', escape((11,  crumb.name )), '</a>\n    ');12; } else { ; buf.push('\n      <a href="#/', escape((13,  crumb.id )), '" class="admin-area">', escape((13,  crumb.name )), '</a>&nbsp;/&nbsp;\n    ');14; } ; buf.push('\n  ');15; }); ; buf.push('\n\n');17; } ; buf.push('\n'); })();
} 
return buf.join('');
}; return function(l) { return t(l) }}())
},{"underscore":12}],31:[function(require,module,exports){
module.exports=(function() {var t = function anonymous(locals, filters, escape, rethrow
/**/) {
escape = escape || function (html){
  return String(html)
...
var buf = [];
with (locals || {}) { (function(){ 
 buf.push('');1; var _ = require('underscore') ; buf.push('\n\n<article>\n  ', (4,  require('./sidebar.html')({ id: '', active: 'projects', crumbs: crumbs }) ), '\n  <div id="content">\n\n    ');7; if (crumbs.length) { ; buf.push('\n    <h1>', (8,  crumbs[crumbs.length-1].name ), '&nbsp;', (8,  type.plural ), '</h1>\n    ');9; } else { ; buf.push('\n    <h1>Projects</h1>\n    ');11; } ; buf.push('\n\n    <table class="table">\n      <tbody>\n        ');15; _.each(tags, function(tag) { ; buf.push('\n        <tr>\n        <td>', (17,  tag.k ), '</td>\n        <td>', (18,  tag.v ), '</td>\n        </tr>\n        ');20; }) ; buf.push('\n      </tbody>\n    </table>\n\n  </div>\n</article>\n'); })();
} 
return buf.join('');
}; return function(l) { return t(l) }}())
},{"./sidebar.html":35,"underscore":12}],33:[function(require,module,exports){
module.exports=(function() {var t = function anonymous(locals, filters, escape, rethrow
/**/) {
escape = escape || function (html){
  return String(html)
...
var buf = [];
with (locals || {}) { (function(){ 
 buf.push('');1; var _ = require('underscore') ; buf.push('\n\n<article>\n  ', (4,  require('./sidebar.html')({ id: '', active: 'projects', type: type, crumbs: crumbs }) ), '\n  <div id="content">\n\n    ');7; if (crumbs.length) { ; buf.push('\n    <h1>', (8,  crumbs[crumbs.length-1].name ), '&nbsp;', (8,  type.plural ), '</h1>\n    ');9; } else { ; buf.push('\n    <h1>Projects</h1>\n    ');11; } ; buf.push('\n\n    <h4>Click on a project for detailed project information.</h4>\n\n    <table class="table">\n      <thead>\n        <tr>\n          ');18; _.each(columns, function(column) { ; buf.push('\n          <th>', (19,  column ), '</th>\n          ');20; }) ; buf.push('\n        </tr>\n      </thead>\n      <tbody>\n        ');24; _.each(projects, function(project) { ; buf.push('\n        <tr class="link-row" data-id="', (25,  project.id ), '">\n        ');26; _.each(project.rows, function(row) { ; buf.push('\n\n        <td>', (28,  row ), '</td>\n        ');29; }) ; buf.push('\n        </tr>\n        ');31; }) ; buf.push('\n      </tbody>\n    </table>\n\n  </div>\n</article>\n'); })();
} 
return buf.join('');
}; return function(l) { return t(l) }}())
},{"./sidebar.html":35,"underscore":12}],34:[function(require,module,exports){
module.exports=(function() {var t = function anonymous(locals, filters, escape, rethrow
/**/) {
escape = escape || function (html){
  return String(html)
...
var buf = [];
with (locals || {}) { (function(){ 
 buf.push('');1; var _ = require('underscore'); ; buf.push('\n');2; var statsForDisplay = require('../lib/stats.js').statsForDisplay; ; buf.push('\n');3; var adminType = require('../lib/admin-type.js'); ; buf.push('\n');4; var subType = adminType.getNext(id); ; buf.push('\n');5; var toFixed = require('../lib/to-fixed.js'); ; buf.push('\n<article>\n', (7,  require('./sidebar.html')({ active: 'road-network', crumbs: crumbs, id: id }) ), '\n  <div id="content">\n\n    <h2>Road Condition</h2>\n\n    ');12; var statsDisplay = statsForDisplay(stats); ; buf.push('\n    <table class="table">\n      <tr>\n        ');15; _.forEach(statsDisplay, function(stat) { ; buf.push('\n          <td>', escape((16,  stat.display )), '</td>\n        ');17; }); ; buf.push('\n      </tr>\n\n      <tr>\n        ');21; _.forEach(statsDisplay, function(stat) { ; buf.push('\n          <td>', escape((22,  toFixed(stat.kilometers, 3) )), ' km</td>\n        ');23; }); ; buf.push('\n      </tr>\n    </table>\n\n    <p>A detailed breakdown of the road condition in kilometer mapped for this municipality\'s barangays.</p>\n\n    <table class="table datatable">\n      <thead>\n        <tr>\n          <th>', escape((32,  subType.plural )), '</th>\n          ');33; _.forEach(_.pluck(statsDisplay, 'display'), function(disp) { ; buf.push('\n          <th class="value">', escape((34,  disp )), '</th>\n          ');35; }); ; buf.push('\n        </tr>\n      </thead>\n      <tbody>\n        ');39; subregions.forEach(function(subregion, i) {
            var id = subregion.id;
            var name = subregion.name; ; buf.push('\n        <tr>\n          <td><a href="#/', escape((43,  id )), '" class="admin-area">', escape((43,  name )), '</a></td>\n          ');44; _.forEach(statsForDisplay(subregion.stats), function(stat) { ; buf.push('\n          <td class="value">', escape((45,  toFixed(stat.kilometers, 3) )), ' km</td>\n          ');46; }); ; buf.push('\n        </tr>\n        ');48; }) ; buf.push('\n      </tbody>\n    </table>\n\n  </div>\n</article>\n'); })();
} 
return buf.join('');
}; return function(l) { return t(l) }}())
},{"../lib/admin-type.js":14,"../lib/stats.js":18,"../lib/to-fixed.js":19,"./sidebar.html":35,"underscore":12}],35:[function(require,module,exports){
module.exports=(function() {var t = function anonymous(locals, filters, escape, rethrow
/**/) {
escape = escape || function (html){
  return String(html)
...
var buf = [];
with (locals || {}) { (function(){ 
 buf.push('');1; var _ = require('underscore') ; buf.push('\n<header>\n  <sup>', (3,  require('./breadcrumbs.html')({ crumbs: crumbs }) ), '</sup>\n\n  ');5; if (crumbs.length) { ; buf.push('\n    <h1>', (6,  crumbs[crumbs.length-1].name ), '</h1>\n  ');7; } else { ; buf.push('\n    <h1>Philippines</h1>\n  ');9; } ; buf.push('\n\n  <div id="admin-search"></div>\n\n  <nav>\n    <ul>\n      <li><a class="', escape((15,  active == 'road-network' ? 'active' : '' )), '" href="#/', escape((15,  id ? id : '' )), '" id="sidebar-road-network">Road Network</a></li>\n      <li><a class="', escape((16,  active == 'projects' ? 'active' : '' )), '" href="#/all/projects" id="sidebar-projects">Projects</a></li>\n    </ul>\n  </nav>\n</header>\n'); })();
} 
return buf.join('');
}; return function(l) { return t(l) }}())
},{"./breadcrumbs.html":30,"underscore":12}],36:[function(require,module,exports){
'use strict';
...
},{"../templates/region.html":34,"./dashboard.js":41}],37:[function(require,module,exports){
'use strict';
...
},{"../config.js":13,"../templates/admin-search-results.html":26,"../templates/admin-search.html":27,"backbone":2,"jquery":4,"underscore":12}],38:[function(require,module,exports){
'use strict';
...
},{"../templates/app.html":28,"./base-view.js":40}],39:[function(require,module,exports){
'use strict';
...
},{"../templates/barangay.html":29,"./dashboard.js":41}],40:[function(require,module,exports){
'use strict';
...
},{"backbone":2}],41:[function(require,module,exports){
'use strict';
...
},{"../lib/spinner.js":17,"./admin-search.js":37,"./base-view.js":40,"datatables":3,"jquery":4}],42:[function(require,module,exports){
'use strict';
...
},{"../templates/region.html":34,"./dashboard.js":41}],43:[function(require,module,exports){
'use strict';
...
},{"../templates/project.html":32,"./base-view.js":40,"datatables":3,"jquery":4}],44:[function(require,module,exports){
'use strict';
...
},{"../lib/spinner.js":17,"../templates/projects.html":33,"./base-view.js":40,"datatables":3,"jquery":4}]},{},[1])
